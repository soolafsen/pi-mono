...
> This fork is for local manual installs only. It does not run GitHub Actions or CI/CD automation.
...
For Slack/chat automation integrations, see [earendil-works/pi-chat](https://github.com/earendil-works/pi-chat).
