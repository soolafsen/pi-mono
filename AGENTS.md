...
## Fork Operating Policy

- This fork is for local installs on the owner's machines.
...
See `CONTRIBUTING.md` for upstream contributor-gate context (`lgtm`/`lgtmi`, quality bar). This fork does not run the auto-close workflows.
...
4. **Local-only fork note**: this fork does not use GitHub Actions or CI/CD publishing. Do not push tags expecting automated builds or npm publishing from this repository.
